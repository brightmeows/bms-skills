...
> → `#SCROLL` 语法详见 [beatoraja-extensions.md](ext/beatoraja-extensions.md#SCROLL)；SCROLL=0 说明详见 [bmse/10-scroll-speed-extensions.md](bmse/10-scroll-speed-extensions.md)
...
> → 详见 [bmse/](bmse/)（BMSE 兼容性参考系列，共 10 篇）
